...
## Project
Marketing/portfolio website for **Columbia Gorge Web Works**. Keep the name in one config/constants file, not hardcoded across components, so it's an easy change if it's ever renamed.
